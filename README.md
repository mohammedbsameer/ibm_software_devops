...
[![CI Build](https://github.com/mohammedbsameer/ibm_software_devops/actions/workflows/ci-build.yml/badge.svg)](https://github.com/mohammedbsameer/ibm_software_devops/actions/workflows/ci-build.yml)

This repository contains the DevOps Capstone Project and course contents for the **IBM DevOps and Software Engineering Professional Certificate**.

### Project Description
The Account REST API Service is a microservice designed to manage the lifecycle of user accounts. It provides standard RESTful endpoints to create, read, update, list, and delete accounts, built using Python, Flask, and PostgreSQL.
